...
class NursingAssistant {
    constructor() {
        ...
        // 認証情報はgoogle-auth.jsで管理
        
        this.initializeElements();
        this.attachEventListeners();
        this.initializeButtonStates();
        // 認証状態チェックはgoogle-auth.jsで処理
    ...
    attachEventListeners() {
        ...
        // Google認証との連携（google-auth.jsが読み込まれている前提）
        // 認証関連の処理は google-auth.js に移譲
